...
import { FlexTriggerStrategyBuilderService } from './overlay-trigger';
...
describe('click-trigger-strategy', () => {
  let triggerStrategyBuilder: FlexTriggerStrategyBuilderService;
  ...
  beforeEach(() => {
    ...
    document = bed.get(FLEX_DOCUMENT);
