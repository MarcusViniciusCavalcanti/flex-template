...
import { FlexPasswordAuthStrategy } from './password-strategy';
import { FlexAuthResult } from '../../services/auth-result';

import { HttpClientTestingModule, HttpTestingController } from '@angular/common/http/testing';
import { RouterTestingModule } from '@angular/router/testing';
import { HttpErrorResponse, HttpResponse } from '@angular/common/http';
import { authCreateToken, FlexAuthSimpleToken } from '../../services/token/token';

const ownerStrategyName = 'strategy';

describe('password-auth-strategy', () => {

  let strategy: FlexPasswordAuthStrategy;
  ...
  const successToken = authCreateToken(FlexAuthSimpleToken, 'token', ownerStrategyName);
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers: [
        { provide: FlexPasswordAuthStrategy, useClass: FlexPasswordAuthStrategy },
      ],
    });
  });

  beforeEach(async(inject(
    [FlexPasswordAuthStrategy, HttpTestingController],
    (_strategy, _httpMock) => {
      strategy = _strategy;
      httpMock = _httpMock;
  ...
  describe('out of the box', () => {
    ...
    it('authenticate success', (done: DoneFn) => {
      strategy.authenticate(loginData)
        .subscribe((result: FlexAuthResult) => {
