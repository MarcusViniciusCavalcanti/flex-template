...
let restoreHelper: FlexRestoreScrollTopHelper;
let router: Router;
...
describe('FlexRestoreScrollTopHelper', () => {
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.configureTestingModule({
      ...
      providers: [FlexRestoreScrollTopHelper],
  ...
  beforeEach(async(inject(
    [FlexRestoreScrollTopHelper, Router],
    (helper, route) => {
