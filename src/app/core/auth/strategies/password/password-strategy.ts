...
import { FlexPasswordAuthStrategyOptions, passwordStrategyOptions } from './password-strategy-options';
import { FlexAuthIllegalTokenError } from '../../services/token/token';

@Injectable()
export class FlexPasswordAuthStrategy extends FlexAuthStrategy {

  protected defaultOptions: FlexPasswordAuthStrategyOptions = passwordStrategyOptions;

  static setup(options: FlexPasswordAuthStrategyOptions): [FlexAuthStrategyClass, FlexPasswordAuthStrategyOptions] {
    return [FlexPasswordAuthStrategy, options];
  }
  ...
  logout(): Observable<FlexAuthResult> {
  ...
  protected handleResponseError(res: any, module: string): Observable<FlexAuthResult> {
    let errors = [];
    if (res instanceof HttpErrorResponse) {
      errors = this.getOption('errors.getter')(module, res, this.options);
    } else if (res instanceof FlexAuthIllegalTokenError) {
