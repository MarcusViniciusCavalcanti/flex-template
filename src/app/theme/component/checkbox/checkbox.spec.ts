...
describe('Component: FlexCheckbox', () => {

  let checkbox: FlexCheckboxComponent;
...
@Component({
  template: `
    <app-flex-checkbox [formControl]="formControl"></app-flex-checkbox>`,
})
...
describe('Component: Checkbox with form control', () => {
  ...
  let checkboxInstance: FlexCheckboxComponent;
  let testComponent: CheckboxWithFormControlComponent;
  let inputElement: HTMLInputElement;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [ReactiveFormsModule, FlexIconModule],
      declarations: [FlexCheckboxComponent, CheckboxWithFormControlComponent],
    });
    ...
    checkboxComponent = fixture.debugElement.query(
        By.directive(FlexCheckboxComponent),
      );
