...
@Component({
  selector: 'app-flex-request-password-page',
  styleUrls: ['./request-password.component.scss'],
  templateUrl: './request-password.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FlexRequestPasswordComponent {
  ...
  requestPass(): void {
    ...
    this.service.requestPassword(this.strategy, this.user).subscribe((result: FlexAuthResult) => {
